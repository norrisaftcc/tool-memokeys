...
if sys.platform == "darwin":  # macOS
    ...
    from AppKit import NSMakeRect, NSFont, NSColor, NSTextAlignment, NSTimer
...
class MemoKeysApp:
    ...
    def setup_ui(self):
        ...
        title_label.setAlignment_(NSTextAlignment.NSTextAlignmentCenter)
        ...
        self.prompt_label.setAlignment_(NSTextAlignment.NSTextAlignmentCenter)
        ...
        self.keys_label.setFont_(NSFont.monospacedSystemFontOfSize_weight_width_(18, 0.0, 0.0))
        self.keys_label.setAlignment_(NSTextAlignment.NSTextAlignmentCenter)
        ...
        self.feedback_label.setAlignment_(NSTextAlignment.NSTextAlignmentCenter)
        ...
        self.score_label.setAlignment_(NSTextAlignment.NSTextAlignmentCenter)
    ...
    def update_score_display(self):
        ...
        self.score_label.setStringValue_(f"Question {current_q}/{self.total_questions} | Score: {self.score}")
    ...
    def show_results(self):
        ...
        self.prompt_label.setStringValue_(f"Test Complete! Score: {self.score}/{self.total_questions} ({percentage}%)")
